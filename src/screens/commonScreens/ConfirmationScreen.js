  ...
  const getConfirmationMessage = () => {
    if (type === 'dealer') {
      return {
        ...
        message:
          'Your dealer account has been successfully created. You can now login to access your dashboard.',
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={{marginTop: 20}}>
        <Card>
          <Text style={styles.titleText}>{confirmationDetails.title}</Text>
          <DottenLine />
          <Text style={styles.messageText}>{confirmationDetails.message}</Text>
        </Card>
      </View>
