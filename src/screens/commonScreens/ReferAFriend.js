    ...
    return (
        <View style={{ flex: 1 }}>
            <View style={styles.container}>
                <Image resizeMode='contain' style={{ width: 300, height: 300 }} source={require("../../assets/referafriendicon.png")} />
                <Text style={styles.title}>Help us grow by inviting your friends and family to join our app!</Text>
            </View>
