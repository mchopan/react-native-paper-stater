    ...
    <View style={{flex: 1, margin: 20}}>
      ...
      <View>
        <Text
          ...
          Total amount to be paid is ₹ 200
        </Text>
      </View>
      <Spacer space={20} />
      ...
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
        ...
        <Pressable
          ...
          <Text
            ...
            Transaction ID:192740KD93JDS98
          </Text>
          <Image
            resizeMode="contain"
    ...
    <View style={{flex: 1, marginHorizontal: 10}}>
      <View style={{alignItems: 'center', marginBottom: 20, marginTop: 20}}>
        <Image
          ...
          resizeMode="contain"
          source={require('../../assets/loadingtruck.png')}
        />
      </View>
      ...
      {!isVehicleTypeMatched && (
        <View style={{padding: 10}}>
          <Text
            style={{fontSize: 10, color: Colors.orange, textAlign: 'center'}}>
            Warning: Your vehicle type ({user?.vehicleType}) is different from
            the required vehicle type ({item?.selectVehicleType}) for this
            booking
          </Text>
        </View>
      )}
      ...
      <View style={styles.buttonContainer}>
        {user?.active ? (
          <>
            <Text
              style={{fontSize: 13, color: Colors.error, textAlign: 'center'}}>
              An existing booking is already in progress
            </Text>
            <CustomButton
              mode="outlined"
      ...
      <Modal
        ...
        <View style={styles.modalStyles}>
          {showSuccessScreen ? (
            <BiltiPayment setShowSuccessScreen={setShowSuccessScreen} />
          ) : (
            <PaymentSuccess setShowSuccessScreen={setShowSuccessScreen} />
          )}
        </View>
      </Modal>
    </View>
